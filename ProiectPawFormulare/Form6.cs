    ...
    public partial class Form6 : Form
    {
        ...
        private void panel1_Paint_1(object sender, PaintEventArgs e)
        {
            ...
            for (int i = 0; i < m.ListaTranzactii.Count; i++)
            {
                ...
                gr.DrawString(m.ListaTranzactii[i].Cantitate_produs.ToString(), this.Font, b, recs[i].Location.X, recs[i].Location.Y - this.Font.Height); 
                Font miniFont = new Font(this.Font.Name, (float)(this.Font.Size-0.2));
